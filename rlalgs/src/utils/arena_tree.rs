...
mod tests {
    ...
    fn test_basic_arena() {
        ...
        assert_eq!(
            first_child,
            arena.get_node(first_child).unwrap().read().unwrap().id
        );
        ...
        assert_eq!(
            1,
            arena.get_node(first_child).unwrap().read().unwrap().depth
        );
        assert_eq!(
            1,
            arena.get_node(second_child).unwrap().read().unwrap().depth
        );
        assert_eq!(
            2,
            arena
                .get_node(first_grandson)
                .unwrap()
                .read()
                .unwrap()
                .depth
